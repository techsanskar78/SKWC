...
export default function ProductCard({ product, onQuickView }: { product: Product; onQuickView?: (p: Product) => void }) {
  ...
  return (
    <div className="group relative">
      <Link href={`/products/${product.slug}`} className="block relative aspect-[3/4] overflow-hidden bg-cream">
        <SmartImage
      ...
      <button
        ...
        className="absolute top-3 right-3 bg-ivory/90 p-2 rounded-full hover:bg-ivory transition"
      >
