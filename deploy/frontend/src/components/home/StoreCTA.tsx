    ...
    <section className="relative overflow-hidden text-ivory py-16 sm:py-28 px-4 pb-24 sm:pb-28">
      ...
      <div className="relative z-10 container-wide text-center">
        ...
        <RevealText
          as="h2"
          delay={0.08}
          text="Your Perfect Wedding Look Awaits"
          className="font-serif text-2xl sm:text-3xl lg:text-5xl mt-3 drop-shadow-[0_8px_24px_rgba(0,0,0,0.45)]"
        />
        <RevealText
          as="p"
          delay={0.2}
          text="Step into the showroom — try the lehenga, pair the jewellery, and leave with a look that feels like you."
          className="mt-4 max-w-xl mx-auto text-ivory/80 text-sm sm:text-base"
        />
